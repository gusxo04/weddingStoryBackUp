                ...
                <tbody>
                  ...
                  <tr className="sd-tr2">
                    ...
                    <td>
                      ...
                      <div className="scheduleDetail-map">
                        {
                          <KakaoMap
                            address={selectedEvent.company.companyAddr}
                          />
                        }
                      </div>
                    </td>
                  ...
                  <tr className="sd-tr3">
                    ...
                    <td>
                      {selectedEvent.companyNo == 0 ? (
                        <Link to="/convention/main">
                          http://localhost:3000/convention/main
                        </Link>
                      ) : (
                  ...
                  <tr className="sd-tr1">
                    ...
                    <td>
                      운영시간{"  "}
                      {selectedEvent.company.startTime} ~{" "}
                      {selectedEvent.company.endTime}
                    </td>
                  </tr>
                </tbody>
              </table>
