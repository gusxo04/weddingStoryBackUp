...
const WriteForm = (props) => {
  ...
  useEffect(() => {
    ...
    const formatShowconventionStartTime = new Date(
      `${conventionStart}T${conventionStartTime}:00`
    );
    const formatShowConventionEndTime = new Date(
      `${conventionStart}T${conventionEndTime}:00`
    );
  ...
  return (
    <>
      ...
      <div className="convention-info-wrap">
          ...
          <div className="input-zone">
            <div className="convention-input-container">
              <div className="start-date-container convention-date-container">
                ...
                <DatePicker
                  id="convention-start-date"
                  selected={showConventionstart}
                  onChange={(date) => {
                ...
                />
                <label
                  className="material-icons convention-date-icon cursor-p"
                  htmlFor="convention-start-date"
                >
                  calendar_month
                </label>
              </div>
              ...
              <div className="end-date-container convention-date-container">
                ...
                <DatePicker
                  id="convention-end-date"
                  selected={showConventionEnd}
                  onChange={(date) => {
                    const year = date.getFullYear();
                    const month = (date.getMonth() + 1)
                      .toString()
          ...
          <div className="input-zone">
            <div className="convention-input-container">
              <div className="start-date-container convention-date-container">
                ...
                <DatePicker
                  id="convention-start-time"
                  selected={showConventionStartTime}
                  onChange={(date) => {
                ...
                />
                <label
                  className="material-icons convention-time-icon cursor-p"
                  htmlFor="convention-start-time"
                >
                  schedule
                </label>
              </div>
              ...
              <div className="end-date-container convention-date-container">
                ...
                <DatePicker
                  id="convention-end-time"
                  selected={showConventionEndTime}
                  onChange={(date) => {
                    const hours = date.getHours();
                    const minutes = date.getMinutes();
                    const formattedTime = `${hours
        ...
        <ToastEditor
          boardContent={conventionContent}
          setBoardContent={setConventionContent}
          type={1}
          writeType={writeType}
        />
      </div>
