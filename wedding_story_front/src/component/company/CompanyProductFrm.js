   ...
   */
	...
	return (
		<div className="companyProduct-wrap">
			<div className="company-title">{url === "/company/product/insert" ? "상품 등록" : "상품 수정"}</div>
			<section className="company-section">
				<div className="thumbnail-zone">
					...
					<input type="file" accept="image/*" onChange={changeImg} ref={imageRef} style={{ display: "none" }}></input>
				</div>
			...
			<div className="editor-zone">
				{url === "/company/product/insert" || (url !== "/company/product/insert" && productContent !== "") ? (
					<ToastEditor boardContent={productContent} setBoardContent={setProductContent} />
				) : (
					""
				)}
			</div>
...
const ThumbnailDiv = (props) => {
	const { productPreThumb, onChangeThumb, productThumb, backServer, url, onUpdateThumb, deleteThumbInsert, deleteThumb } = props;
	const thumbRefs = useRef([]);
		...
		<>
			{url === "/company/product/insert"
              ...
              material-icons"
								...
								<img src={"/image/default_img.png"} onClick={() => thumbRefs.current[index].click()} />
							)}
