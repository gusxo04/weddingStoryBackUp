		...
		<div className="member-controll-wrap">
			...
			<div className="tbl-wrap">
				...
				<div className="del-btn-wrap">
					<button className="member-delBtn main-btn" onClick={delMem}>
						회원 탈퇴
					</button>
				</div>
			...
			<MemberInfo selectedMember={selectedMember} setSelectedMember={setSelectedMember} />
		</div>
	);
};
		...
		<>
			<div className="memberInfo-wrap">
				...
				<div className="partner">
					<h3>
						파트너 상세
						{partner === null ? <></> : partner.memberType === 4 ? <span>(탈퇴한회원)</span> : <span></span>}
					</h3>
					{partner === null ? (
						<a>배우자가 등록되지 않았습니다.</a>
					) : (
